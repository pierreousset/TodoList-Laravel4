...
<form action="" method="post">
    ...
    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label deplace">
      <ul class="demo-list-item mdl-list">
        <li class="mdl-list__item">
          <input class="mdl-textfield__input" type="text" id="sample3" name="user" value="<?= $note->user ?>" required>
  ...
  <div class="demo-card-wide mdl-card mdl-shadow--2dp">
    <div class="mdl-textfield mdl-js-textfield deplace">
      <textarea class="mdl-textfield__input" type="text" rows= "3" id="sample5" name="note" value="<?= $note->note ?>" required></textarea>
